    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Architected and implemented a React Native based MVP mobile android application leveraging geolocation services to connect nearby users for spontaneous conversations}
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed web-based OSI model simulator using React that visualizes data encapsulation/decapsulation across all network layers}
